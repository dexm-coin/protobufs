...
func (m *MerkleRootsSigned) GetPublicKey() []byte {
	if m != nil {
		return m.PublicKey
	}
	return nil
...
func (m *SignSchnorr) GetWallet() []byte {
	if m != nil {
		return m.Wallet
	}
	return nil
...
func (m *Schnorr) GetPublicKey() []byte {
	if m != nil {
		return m.PublicKey
	}
	return nil
...
func (m *AccountState) GetPublicKey() []byte {
	if m != nil {
		return m.PublicKey
	}
	return nil
...
func (m *ContractState) GetPublicKey() []byte {
	if m != nil {
		return m.PublicKey
	}
	return nil
...
func (m *MerkleProof) GetPublicKey() []byte {
	if m != nil {
		return m.PublicKey
	}
	return nil
...
func (m *MoneyWithdraw) GetPublicKey() []byte {
	if m != nil {
		return m.PublicKey
	}
	return nil
...
var fileDescriptor_e9ac6287ce250c9a = []byte{
	...
	,
}
